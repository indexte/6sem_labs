...
public class Controller {
    ...
    @FXML
    private void addCompany(ActionEvent event) throws IOException, ClassNotFoundException {
    ...
    @FXML
    private void addFlight(ActionEvent event) throws IOException, ClassNotFoundException {
    ...
    @FXML
    private void updateCompany(ActionEvent event) throws IOException, ClassNotFoundException {
    ...
    @FXML
    public void updateFlight(ActionEvent event) throws IOException, ClassNotFoundException {
    ...
    @FXML
    public void deleteCompany(ActionEvent event) throws IOException, ClassNotFoundException {
        TreeItem<String> selectedItem =(TreeItem<String>)treeView.getSelectionModel().getSelectedItem();
        if(selectedItem == null){
            information.setText("Not selected aircompany");
            return;
    ...
    @FXML
    public void deleteFlight(ActionEvent event) throws IOException, ClassNotFoundException {
        TreeItem<String> selectedItem =(TreeItem<String>)treeView.getSelectionModel().getSelectedItem();
        if(selectedItem == null){
            information.setText("Not selected aircompany");
            return;
